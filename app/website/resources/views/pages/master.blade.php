...
<head>
    ...
    <!-- font-awesome -->
    <link href="source/assets/fonts/font-awesome/font-awesome.min.css" rel="stylesheet">
    <!-- Mobile Menu Style -->
    <link href="source/assets/css/mobile-menu.css" rel="stylesheet">

    <!-- Owl carousel -->
    <link href="source/assets/css/owl.carousel.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar">
                    ...
                    <div class="container">
                        <div class="header-section">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="logo">
                                        <a href="index.html"><img src="source/assets/img/logo.png" alt="Tech NewsLogo"></a>
                                    </div>
                                    <!-- Logo Section -->
                                </div>
                                <div class="col-md-4">
                            ...
                            <nav class="navbar m-menu navbar-default">
                                <div class="container">
                                    ...
                                    <div class="navbar-header">
                                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-1"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span>
    ...
    <!-- jquery Core-->
    <script src="source/assets/js/jquery-2.1.4.min.js"></script>

    <!-- Bootstrap -->
    <script src="source/assets/js/bootstrap.min.js"></script>

    <!-- Theme Menu -->
    <script src="source/assets/js/mobile-menu.js"></script>
